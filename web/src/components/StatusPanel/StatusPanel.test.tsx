...
describe('StatusPanel', () => {
  ...
  it('shows train counts', () => {
    const trains = new Map([
      ['t1', { trip_id: 't1', route_id: 'r1', status: 'live', latitude: 0, longitude: 0, bearing: 0, position_updated_at: null, schedule_updated_at: null, last_seen_at: null }],
      ['t2', { trip_id: 't2', route_id: 'r2', status: 'coasting', latitude: 0, longitude: 0, bearing: 0, position_updated_at: null, schedule_updated_at: null, last_seen_at: null }],
      ['t3', { trip_id: 't3', route_id: 'r3', status: 'ghost', latitude: 0, longitude: 0, bearing: 0, position_updated_at: null, schedule_updated_at: null, last_seen_at: null }],
    ])
    render(
