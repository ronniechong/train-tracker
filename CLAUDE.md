...
| Frontend hosting | GitHub Pages project site (`/train-tracker/` path), fronted by a custom domain rather than the bare `*.github.io` URL; API's CORS allowlist must include the custom domain, not just `*.github.io` | Domain changes |
